...
st.markdown('''
The first 6-months of growth targets the development of the Horizon’s AI IP, pilot locations to test the app within set parameters, and marketing to two key customer segmentations to gauge interest in the Horizon product.
This is detailed in the 6 Month Operation Plan below:
''')
st.image('images/6-month-plan.png')
st.write("#")

st.subheader("Exit Stategies", divider=True)
st.markdown('''
...
st.subheader("Potential growth markets", divider=True)
st.markdown('''
...
st.subheader("Investor Offer", divider=True)
st.markdown('''
