...
st.subheader("Target Segmentations and Value Propositions", divider=True)
st.markdown('''
...
st.subheader("Horizon Customer and Supplier Positioning", divider=True)
st.markdown('''
...
''')
st.divider()
st.subheader("Evaluation of Market Competitors", divider=True)
