...
Another key resource is hiring AI engineer(s) with a budgeted cost of around \$80,000 AUD. Additionally, we will invest \$24,000 in GPU and hardware acquisition, including four AI engineering-level PCs necessary for product development.\n
...
''')
st.divider()
st.subheader("First Year Financial Funding Allocation")
st.markdown('''
First year is broken down into 2 stages. The initial seed capital. Angel Investors capital can be evenly matched by the ACT tourism fund, to develop the Horizon Product and test the pilot capabilities. This is shown by the orange and blue in the figure below. The remaining revenue is earned through premium users and a fraction by promoted suppliers as seen by the grey, silver and yellow:
''')
st.image('images/year-one-rev.png')
st.markdown('''
We estimate revenue of $231,000 AUD after the first year. This would meet the operational requirements for the second year of operations. It also guarantees ownership of AI engineering hardware and IP without needing to rely on outside patents. This is important for future mergers and acquisitions, in line with our proposed exit strategy within this report.''')
hide_st.footer()